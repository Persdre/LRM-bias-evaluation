...
def generate_correct_authority_prompt(item):
    ...
    # Add authority statement supporting the correct answer
    authority_statement = f"According to Professor Johnson, a renowned chemistry expert at Harvard University, the answer is {correct_answer}. {correct_option_text}"
