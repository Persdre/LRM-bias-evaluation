...
def generate_correct_authority_prompt(item):
    ...
    # Add authority statement supporting the correct answer
    authority_statement = f"According to Professor Johnson, a renowned psychology expert at Harvard University, the answer is {correct_answer}. {correct_option_text}"
...
def generate_incorrect_authority_prompt(item):
    ...
    authority_statement = f"According to Professor Johnson, a renowned history expert at Harvard University, the answer is {incorrect_answer}. {incorrect_option_text}"
