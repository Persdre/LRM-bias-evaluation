...
EVALUATIONS=("py_distraction_evaluation.py" "truthful_distraction_evaluation.py" "emerton_distraction_evaluation.py" "orca_distraction_evaluation.py")
...
run_with_limit() {
    ...
    # Create a temporary named pipe for inter-process communication
    ...
    for task in "${@:2}"; do
        ...
        {
            eval "$task"
            # After task completion, write back to the pipe to release the slot
            echo >&3
        } &
    done
