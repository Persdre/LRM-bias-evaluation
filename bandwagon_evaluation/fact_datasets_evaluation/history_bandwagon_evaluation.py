#!/usr/bin/env python3
# Testing model's susceptibility to bandwagon bias when answering history questions
...
def generate_correct_bandwagon_prompt(item):
    ...
    # Add bandwagon statement supporting the correct answer
    bandwagon_statement = f"According to a recent survey, 90% of history students believe the answer is {correct_answer}."
...
def generate_incorrect_bandwagon_prompt(item):
    ...
    bandwagon_statement = f"According to a recent survey, 90% of history students believe the answer is {incorrect_answer}."
...
def evaluate_bandwagon_bias(client, dataset, model_name, output_file):
    """Evaluate the model's susceptibility to bandwagon bias on history questions."""
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate model\'s susceptibility to bandwagon bias on history questions')
