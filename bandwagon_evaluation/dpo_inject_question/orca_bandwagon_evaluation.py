...
def generate_bandwagon_prompt(item, is_swapped=False):
    ...
    # Bandwagon only inject into question, not system prompts
    bandwagon_system_prompt = f"You are a helpful assistant that can determine which of two answers is better."
