...
# # # this is to evaluate the bandwagon bias on the py dataset
# python emerton_bandwagon_evaluation.py --model deepseek-r1 --samples 100 &
# python emerton_bandwagon_evaluation.py --model deepseek-v3 --samples 100 &
# # this is to evaluate the bandwagon bias on the orca dataset
# python orca_bandwagon_evaluation.py --model deepseek-r1 --samples 100 &
# python orca_bandwagon_evaluation.py --model deepseek-v3 --samples 100 &
# this is to evaluate the bandwagon bias on the py dataset
# python py_bandwagon_evaluation.py --model deepseek-r1 --samples 100 &
# python py_bandwagon_evaluation.py --model deepseek-v3 --samples 100 &

# # this is to evaluate the bandwagon bias on the truthful dataset
# python truthful_bandwagon_evaluation.py --model deepseek-r1 --samples 100 &
# python truthful_bandwagon_evaluation.py --model deepseek-v3 --samples 100 &
...
# Set maximum number of parallel tasks - increased to 12
MAX_PARALLEL=12

# Model list: deepseek-r1, deepseek-v3, gpt-4o, o3-mini
# MODELS=("deepseek-r1" "deepseek-v3" "gpt-4o" "o3-mini" "deepseek-r1-distill-llama-70b")
MODELS=("llama-3.3-70b-instruct")
# Evaluation script list
EVALUATIONS=("py_bandwagon_evaluation.py" "truthful_bandwagon_evaluation.py" "emerton_bandwagon_evaluation.py" "orca_bandwagon_evaluation.py")
